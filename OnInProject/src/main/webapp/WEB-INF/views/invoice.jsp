...
.WKuqR:focus, .WKuqR:active, .WKuqR:hover {
	color: #00d387;
}
				...
				<div class="sc-dNoQZL dDgyXN">
					<div class="sc-gCwZxT kEouQA">
						<div class="sc-jOVcOr ixlgyn">
							...
							<div class="sc-eQGPmX jvXLhQ">
								<a href="/mypage/invoice?mno=${loginMember.mno}" class="sc-dAOnuy gyJIGO"><img
					...
					<div class="sc-eweMDZ idLzqq">
						<p color="#191919" class="sc-bxivhb sc-ckYZGd eOzNQX">Invoice</p>
						<div class="sc-bWFPNQ fkGnFq">
							<div class="sc-cBOTKl iiwFBh">
								<ul class="sc-dYcyhn Aqbls">
									<li class="sc-bQduHL eXGkyY"><a class="sc-iUpOdG WKuqR">보낸의뢰요청서</a>
									</li>
								</ul>
								<!-- invoice 테이블에 값이 없으면 -->

								<c:if test="${empty list}">
									<div class="sc-hkHFWD fmIebr">
										<div class="sc-dfVpRl iTthma">
											<div class="infinite-scroll-component__outerdiv">
												<div class="infinite-scroll-component "
													style="height: auto; overflow: visible;">
													<div class="sc-hwwEjo guUrk">
														<p class="sc-kPVwWT hQSOWO">요청하신 의뢰가 없습니다.</p>
														<a href="/estimate" class="sc-kfGgVZ bjduXL">의뢰요청 하러
															가기</a>
													</div>
												</div>
											</div>
...
<%-- 										${list.cno}, ${list.cnoref}, ${list.q1}, --%>
<%-- 										${list.q2}, ${list.ad}, ${list.invoice_date}, --%>
<%-- 										${list.cost}, ${list.send_date}<br> --%>
<%-- 									</c:forEach> --%>
                      ...
                      <table class="table table-borderless table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0 text-muted">${list.CNAME}</p>
                              
                            </td>
                            <td>
                              <p class="mb-0 text-muted">${list.invoice_date}</p>
                              
                            </td>
                            <td>
                              <p class="mb-0 text-muted">${list.cost}원</p>
                              
                            </td>
                            <td class="w-25">
                            <small class="text-muted"> ${list.q1}<br>${list.q2}</small>
                            </td>
                            <td class="text-muted">${list.ad}</td>
