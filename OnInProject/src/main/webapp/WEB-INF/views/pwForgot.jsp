...
<meta charSet="utf-8" />
<title>비밀번호 찾기 | 전문가 매칭 플랫폼 ON-IN</title>
...
<style
	data-styled="kdtjOQ jmbAFp JXlWL kBvlYL OZoVQ iQSKvq LOgNr loTjFL eIEXWC VKktY drBCjk hPoZmI hRLeCu bscqcK boFQBu iVogkW dQiHqs fSkSkR eDatwz hUMmIm gQorcQ eDCNLl buSScp bxvfV fpBBuI fkjkfb lckicf fvAyeb dZGvHr fKltYN gikaNn gVtAHb oHkMU ktBaKe glyfuW ijullp bUwjoZ kUKQcj bAKVje ftwcRb jCeSos ksfJEf dgoFik fkIeKB gSfURU qEHPE jKmBqF eAugEp eSRUic isIIme iiYskj jIyWnK jlYqWR jLFQGw ANjrS gKXsws gBjaoW jSzkPZ gQHXag hRQZQm hxWWju gQuMFF fyVqUN"
...
.dgoFik::-webkit-input-placeholder {
	color: #9d9d9d;
	text-align: left;
}

.dgoFik::-moz-placeholder {
	color: #9d9d9d;
	text-align: left;
}

.dgoFik:-ms-input-placeholder {
	color: #9d9d9d;
	text-align: left;
}
...
.fpBBuI {
	...
	background-image: url('https://pren.kr/static/password/background.jpg');
				...
				<div class="fresnel-container fresnel-greaterThan-xs ">
					<div class="fresnel-container fresnel-greaterThan-xs ">
						<div class="sc-nrwXf bxvfV">
							<div class="sc-eitiEO fpBBuI">
								<div width="967px" class="sc-bhlBdH lckicf">
									<div>
										<div class="fresnel-container fresnel-greaterThan-xs ">
											<img src="https://pren.kr/static/Icon/logo.svg" alt="logo"
												width="124px" height="62px" />
											<p color="#000000" class="sc-bxivhb sc-fhiYOA gikaNn">비밀번호
												찾기</p>
										</div>
										<div class="fresnel-container fresnel-greaterThan-xs ">
