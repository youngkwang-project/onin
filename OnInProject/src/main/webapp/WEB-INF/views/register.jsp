...
.jIURMm::after {
	content: '';
	min-width: calc(17px - 4px);
	max-width: calc(- 4px);
	height: calc(17px - 4px);
	border-radius: 50%;
	background-color: #cccccc;
	display: none;
}
...
.JWpsr {
	...
	background-image: url('https://pren.kr/static/signup/background.jpg');
...
<body>
	...
	<div id="__next">
		<div class="sc-dymIpo kdtjOQ">
			<h1 class="sc-gwVKww jmbAFp">전문가 매칭 플랫폼 ON-IN</h1>
										...
										<div class="fresnel-container fresnel-greaterThan-xs ">
											<div class="sc-cXHFlN flDCkP">
												<form method="post" action="register">
													...
													<div class="sc-ifAKCX ktBaKe">
														<div width="452px" class="sc-ihiiSJ flypWG">
															<p class="sc-bxivhb sc-iNovjJ cftYnu">본인인증</p>
